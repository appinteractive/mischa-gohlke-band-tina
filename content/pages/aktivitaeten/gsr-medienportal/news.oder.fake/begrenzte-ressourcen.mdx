...
description: >-
  Das Recht eines jeden Menschen auf Nahrung – und zwar in ausreichender
  Quantität und Qualität – ist ein Menschenrecht, das im internationalen Pakt
  über wirtschaftliche, soziale und kulturelle Rechte (VN-Sozialpakt
  (https://www.sozialpakt.info/)) völkerrechtlich verbindlich verankert ist.
wide: false
gallery: []
alias: ''
accessible: ''
