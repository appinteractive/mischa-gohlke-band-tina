...
description: >-
  Eine angeborene Sprachfähigkeit wird üblicherweise nicht angezweifelt,
  allerdings besteht Uneinigkeit darüber, welche Fähigkeiten genau vorausgesetzt
  werden können und welche erlernt werden.
wide: false
gallery: []
alias: ''
accessible: ''
