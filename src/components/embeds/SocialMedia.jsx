 ...
 */
export default function SocialMedia({ type, hasSubNav, ...props }) {
  const headline = defaultText(props?.headline, 'Überschrift')
  ...
  return (
    <div
      className={clsx(
        'not-prose relative my-24 mb-28 max-w-7xl space-y-4',
